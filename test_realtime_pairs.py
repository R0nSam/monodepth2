...
def test_simple(args):
    ...
    with torch.no_grad():
        ...
        while True:
            ...
            input_image1 = cv2.cvtColor(input_image1, cv2.COLOR_BGR2RGB)   # BGR to RGB conversion
            ...
            input_image2 = np.array(input_image2)
            input_image2 = cv2.cvtColor(input_image2, cv2.COLOR_BGR2RGB)   # BGR to RGB conversion
